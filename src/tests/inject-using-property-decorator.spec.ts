...
const depWithSymbolKey = Symbol.for("symbolFieldNameDependency");
...
describe("Inject using decorator", () => {
  describe("when scope = DEFAULT", () => {
    ...
    class TestService {
      ...
      @Inject()
      readonly depWithNoneKey!: DependencyWithNoneKey;
    }
    ...
    it("should get TestService", async () => {
      ...
      expect(service.depWithNoneKey).toBeInstanceOf(DependencyWithNoneKey);
